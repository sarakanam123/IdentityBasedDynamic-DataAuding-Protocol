...
public class SimpleFTPClient {
	...
	public static void encrypt(InputStream is, OutputStream os,String mykey) throws Exception {
		encryptOrDecrypt(mykey, Cipher.ENCRYPT_MODE, is, os);
	}

	public static void decrypt(InputStream is, OutputStream os,String mykey) throws Exception {
